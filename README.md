...
## image of each main interface where professors can track students grades
...
## image of a specific lecture, showcasing each students contribution grade that professors can then modify after lecture. 
